...
module Shared {
     ...
     */
    export interface IAuthResource extends ng.resource.IResourceClass<IUserToken> {
        /** Api przed zalogowaniem */
    ...
    export module API {
         ...
         * bo jest to factory
         */
        export function AuthResource($resource: ng.resource.IResourceService) {
            return <IAuthResource> $resource('/auth/:action', {}, {
                  login: loginAction
